<template>
  <div class="h-full pb-20 dark:bg-black w-full absolute top-0 z-30 overflow-y-auto">
    <section class="px-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <section class="flex h-full">
                    <div class="text-center mr-3 max-w-[70px] truncate">
                        <p class="font-bold">{{users.length}}</p>
                        <p>Publicaciones</p>
                    </div>
                    <div class="text-center mr-3 max-w-[70px] truncate">
        ...
        <ul class="flex max-w-screen overflow-x-auto mt-3">
            <label for="destacados">
                ...
                <li class="bg-black border-2 flex items-center justify-center border-white w-[70px] h-[70px] rounded-full mr-3">
                    <img src="../assets/icons/bx-plus.svg" alt="Agregar Historia Favorita" class="icons">
                </li>
            </label>
    ...
    <post-profile-component></post-profile-component>
  </div>
</template>
...
<script setup>
    ...
    import PostProfileComponent from "./PostProfileComponent.vue"
    const {
